...
$dataQuery = mysqli_query($conn,"SELECT `id`, `type`, `title`, `img`, `desc`, `date_time`, `status` FROM `".$tblPrefix."cms_pages` WHERE type = 4 AND status > 0");
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="card-body row justify-content-center">
                                    ...
                                    <div class="col-lg-5 my-2">
                                        <div class="card m-b-30">  
                                            ...
                                            <div class="card-body">
                                                <p class="card-text"><?php echo htmlspecialchars_decode(substr($datahit['desc'],0,150));?>...</p>
                                            </div>
                                            <div class="card-footer">
                                                <a  href="add-who-we-are.php?id=<?php echo $datahit['id']?>" class="edit-this btn btn-primary">Edit</a>
...
<a href="add-who-we-are.php" class="btn-floating btn btn-primary" id="Add Section" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add">
